...
namespace Yor
{
  Unique<ImGUIDisplay> ImGUIDisplay::Builder::build() const
  {
		IMGUI_CHECKVERSION();
		ImGui::CreateContext();
		...
		case ApplicationBackend::OpenGL: return CreateUnique<OGL::OGL_ImGUIDisplay>();
		}
		
		return nullptr;
  }

  void ImGUIDisplay::useDarknessTheme()
  {
